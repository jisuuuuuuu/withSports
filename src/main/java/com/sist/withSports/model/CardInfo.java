...
public class CardInfo implements Serializable
{
	...
	private String purchase_corp;			//카카오페이 매입 카드사 한글명
	private String purchase_corp_code;		//카카오페이 매입 카드사 코드
	private String issuer_corp;				//카카오페이 카드 발급사 한글명
	private String issuer_corp_code;		//카카오페이 카드 발급사 코드
